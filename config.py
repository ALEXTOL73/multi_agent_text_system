...
Точность: [число от 0 до 1]
Полнота: [число от 0 до 1]
Краткость: [число от 0 до 1]
Ясность: [число от 0 до 1]
Соответствие_эталону: [число от 0 до 1]
Именованные_сущности: [число от 0 до 1]
Explanation: [конкретное объяснение оценки на русском языке]

ВАЖНО: Сначала укажи числовую оценку для каждого критерия в указанном формате (Критерий: число), затем дай объяснение после "Explanation:". Не включай критерии в текст объяснения. Обязательно укажи все 6 критериев с числовыми значениями."""
...
Предоставь оценку в следующем формате:
Точность: [число от 1 до 10]
Полнота: [число от 1 до 10]
Краткость: [число от 1 до 10]
Ясность: [число от 1 до 10]
Соответствие_эталону: [число от 1 до 10]
Именованные_сущности: [число от 1 до 10]
