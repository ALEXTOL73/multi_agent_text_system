...
3. Загрузите модель (например, Gemma 3 12B)
...
```text
┌─────────────────┐    ┌──────────────────┐    ┌─────────────────┐
│  Входной текст   │───▶│  Коррекция текста │───▶│ Суммаризация     │
└─────────────────┘    └──────────────────┘    └─────────────────┘
                              │                         │
                              ▼                         ▼
                       ┌──────────────┐         ┌──────────────┐
                       │ Метрики WER  │         │ Метрики ROUGE │
                       │ LevRating     │         │ G-Eval        │
...
| **LevRating** | 0-1        | Levenshtein Rating (выше лучше) |
...
| Метрика       | Диапазон   | Описание                      |
|:--------------|:-----------|:-----------------------------|
| **G-Eval**    | 0-1        | Генеративная оценка           |
| **LLM-Judge** | 1-10       | Оценка LLM-судьи              |
| **METEOR**    | 0-1        | Метрика схожести              |
